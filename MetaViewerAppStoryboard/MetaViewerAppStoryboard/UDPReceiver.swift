...
private struct FragmentBuffer {
    ...
    func assemble() -> Data {
        ...
        let sortedKeys = fragments.keys.sorted()
...
final class UDPReceiver {
    ...
    private func processPacket(_ data: Data) {
        ...
        print("[UDPReceiver] packet size:", data.count)
        ...
        if fragmentBuffers[key] == nil {
            fragmentBuffers[key] = FragmentBuffer(header: header,
                                                   ...
                                                   createdAt: Date())
            print("[Reassembler] frame \(header.frameIndex) fragment \(header.fragmentIndex)/\(header.totalFragments)")
        }
